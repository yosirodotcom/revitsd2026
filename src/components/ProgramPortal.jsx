        ...
        <div className="lg:col-span-5 flex flex-col justify-between p-8 md:p-12 lg:p-16 relative z-10 bg-white" style={{ backgroundColor: '#ffffff' }}>
          ...
          <div className="my-auto py-10 max-w-sm w-full mx-auto space-y-6">
            ...
            <div className="flex justify-center gap-4 py-1">
              {[
                { name: 'Google', svg: 'M12.24 10.285V13.4h6.887c-.275 1.565-1.88 4.604-6.887 4.604-4.33 0-7.866-3.577-7.866-8s3.536-8 7.866-8c2.46 0 4.105 1.025 5.047 1.926l2.427-2.334C17.955 2.192 15.34 1 12.24 1 6.033 1 1 6.033 1 12.24s5.033 11.24 11.24 11.24c6.478 0 10.793-4.537 10.793-10.983 0-.746-.08-1.32-.176-1.885H12.24z' },
                { name: 'Apple', svg: 'M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M15.97 4.17c.66-.81 1.11-1.93.99-3.06-1 .04-2.22.67-2.93 1.49-.62.69-1.16 1.84-1.01 2.96 1.12.09 2.27-.56 2.95-1.39' },
                { name: 'Facebook', svg: 'M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z' }
              ].map(social => (
                <button
                  key={social.name}
                  type="button"
                  className="w-10 h-10 rounded-full flex items-center justify-center text-white hover:opacity-85 transition-all cursor-pointer border-0"
                  title={`Continue with ${social.name}`}
                  style={{ borderRadius: '50%', backgroundColor: '#000000', color: '#ffffff', border: 'none', width: '40px', height: '40px' }}
                >
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24" style={{ fill: '#ffffff' }}>
                    <path d={social.svg} />
                  </svg>
                </button>
              ))}
