        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-slate-900/40 backdrop-blur-xl border border-slate-800/80 rounded-3xl p-5 shadow-xl flex flex-col justify-between">
            ...
            <div className="relative w-full overflow-x-auto no-scrollbar">
              ...
              <div className="absolute bottom-[36px] right-[175px] z-10 flex items-center bg-slate-950/90 backdrop-blur-md border border-slate-800 rounded-xl p-1 shadow-xl">
                <button
